...
const TimeLine = () => {
    return (
        <>
            <section
                className="w-full bg-white relative pt-30 z-30 hidden md:block"
                id="infos"
            >
                        ...
                        <div className="relative flex flex-col gap-y-2 items-center">
                            ...
                            <div className="flex flex-col items-center gap-y-4">
                                <ul className="flex flex-col justify-center items-center text-md text-[#2C3058] roboto-regular">
                                    <li>
                                        <b>Depuis Paris :</b> environ 1h30 via
                                        l'A10
                                    </li>
                                    <li>
                                ...
                                <span className="text-md text-[#2C3058] roboto-regular">
                                    Le Château se situe à environ 5 minutes de
                                    la sortie.
                                </span>
                                <DownloadButton
                        ...
                        <div className="relative flex flex-col gap-y-6 items-center mt-40">
                            ...
                            <div className="flex flex-col items-center gap-y-4">
                                <ul className="flex flex-col justify-center items-center text-md text-[#2C3058]">
                                    <li>
                                        Prenez un train jusqu’à la gare
                                        d’Orléans
                                    </li>
                                ...
                                <ul className="flex flex-col justify-center items-center text-md text-[#2C3058]">
                                    ...
                                    <li className="italic text-center">
                                        Le trajet en taxi ou Uber jusqu’au
                                        Château du Rollin <br />
            ...
            <section
                className="w-full bg-[#D9D9D933] h-[300px] relative z-30 md:hidden mb-10 px-3"
                id="infos"
            >
                <div className="w-full flex justify-center items-center mb-20 relative z-20 py-5">
                    <Title
                        title="Infos pratiques"
                        className="text-2xl !text-[#47A185]  relative"
                    />
                </div>
                <Swiper
                    ...
                    autoplay={{ delay: 5000 }}
                    className="bg-transparent absolute drop-shadow-xl rounded-xl left-0 right-0 -top-10 px-3"
                >
                    <SwiperSlide className="w-full">
                        <div className="rounded-xl drop-shadow-xl p-4 bg-white">
                            <div className="flex flex-col gap-y-3 justify-center items-center">
                                <div className="w-24 h-24 rounded-full bg-[#2C3058] flex justify-center items-center relative z-[10]">
                                    <img
                                        src="./images/car.svg"
                                        alt="gift&cse"
                                        className="w-8 h-8"
                                ...
                                <div className="flex items-end">
                                    <span className="uppercase text-[#2C3058]  roboto-bold text-2xl">
                                        en voiture
                                    </span>
                                </div>
                                <div className="flex flex-col justify-center items-center gap-y-4">
                                    <ul className="flex flex-col justify-center items-center text-[12px] text-[#2C3058] roboto-regular">
                                        <li>
                                            <b>Depuis Paris :</b> environ 1h30
                                            via l'A10
                                        </li>
                                        <li>
                                            <b>Depuis Bourges :</b> environ 1h45
                                        ...
                                        <li>
                                            <b>Depuis Angers :</b> environ 2h10
                                            via l’A11 et l’A10
                                        </li>
                                    </ul>
                                    <ul className="flex flex-col justify-center items-center text-[12px] text-[#2C3058] roboto-regular">
                                        <li>
                                            <b>
                                                Sortie d'autoroute recommandée :
                                            </b>
                                        </li>
                                        <li>
                                            Prenez la sortie{" "}
                                    ...
                                    <span className="text-[11px] text-[#2C3058] roboto-regular">
                                        Le Château se situe à environ 5 minutes
                                        de la sortie.
                                    </span>
                                    <DownloadButton
                                        title="Itinéraire &nbsp<b>sur Maps</b>"
                                        className="h-10 !bg-[#2C3058] mt-5 hover:!bg-[#47A185] !flex"
                                        linkHref="https://maps.app.goo.gl/gAenF9bcWNZYRNsn9"
                                    />
                                </div>
                            </div>
                    ...
                    <SwiperSlide className="w-full">
                        <div className="rounded-xl drop-shadow-xl p-4 bg-white">
                            <div className="flex flex-col gap-y-3 justify-center items-center">
                                ...
                                <div className="flex flex-col items-center gap-y-4">
                                    <ul className="flex flex-col justify-center items-center text-[12px] text-[#2C3058]">
                                        <li>
                                            Prenez un train jusqu’à la gare
                                            d’Orléans
                                        </li>
                                    ...
                                    <ul className="flex flex-col justify-center items-center text-[12px] text-[#2C3058]">
                                        ...
                                        <li>
                                            sont disponibles à la sortie de la
                                            gare.
                                        </li>
                                        <li className="italic text-center">
                                            Le trajet en taxi ou Uber jusqu’au
                                    ...
                                    <DownloadButton
                                        title="Itinéraire &nbsp<b>sur Maps</b>"
                                        className="h-10 !bg-[#47A185]  hover:!bg-[#F8AD47] !flex"
                                        linkHref="https://maps.app.goo.gl/gAenF9bcWNZYRNsn9"
                                    />
                                </div>
                            </div>
                    ...
                    <SwiperSlide className="w-full">
                        <div className="rounded-xl drop-shadow-xl p-4 bg-white">
                            <div className="flex flex-col gap-y-3 justify-center items-center">
                                <div className="w-24 h-24 rounded-full bg-[#F8AD47] flex justify-center mt-10 items-center  relative">
                                    <img
                                        src="./images/pin.svg"
                                        alt="gift&cse"
                                        className="w-8 h-8"
                                ...
                                <div className="flex gap-x-4 justify-center">
                                    <div className="flex flex-col justify-between items-center">
                                        <h3 className="uppercase text-[#F8AD47] font-bold text-xl relative pb-3 roboto-bold">
                                            Château du rollin
                                        </h3>
                                        <span className=" text-[#2C3058] font-bold text-lg relative bottom-3 roboto-bold">
                                            Option nuitée
                                        </span>
                                    </div>
                                </div>
                                <div className="relative flex flex-col gap-y-6 items-center">
                                    <div className="flex flex-col items-center gap-y-4">
                                        <ul className="flex flex-col justify-center items-center text-sm text-[#2C3058] roboto-regular">
                                            <li className="text-center">
                                                possible à l’hôtel du château{" "}
                                                <br /> (sur réservation,
                                                contactez-nous)
                                            </li>
                                        </ul>
                                        <button
                                            ...
                                            className="bg-[#F8AD47] h-10 px-10 py-3 rounded-lg text-white cursor-pointer duration-500 ease-in-out transition-all hover:bg-[#2C3058]"
                                        >
                                            Réserver <b> une Nuitée</b>
                                        </button>
                                        {/* <DownloadButton
